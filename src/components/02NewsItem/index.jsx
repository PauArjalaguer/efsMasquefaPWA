...
const NewsItem = (props) => { 
    return (
        ...
        })} to={"/noticies/detall/"+props.data.idNew}> <div key={props.idNew} className='w-full bg-white mb-1 p-2 border border-solid border-azure-700 flex '>
                <div className='w-1/2 p-1'>
                    <img className='w-full rounded-lg ' src={"http://jok.cat/" + props.data.newsImage} />
                </div>
                <div className='w-1/2 p-1 flex flex-col flex-1'>
                    <div className='text-xs font-bold text-right h-3/4 bg-white  justify-end text-azure-900'> {props.data.newsTitle}</div>
