...
import { faFutbolBall, faHouse, faNewspaper, faTrophy, faUsers, faPhotoVideo } from '@fortawesome/free-solid-svg-icons'
import React from 'react'
import { NavLink } from 'react-router-dom';

const bottomTabs = () => {
    return (
        <div className="fixed bottom-0 left-0 z-50 w-full h-16 bg-white border-t border-gray-700 dark:bg-gray-700 dark:border-gray-600 pt-2 px-4 ">
            <div className="grid h-full max-w-lg grid-cols-6 mx-auto font-medium">
                <button type="button" className="inline-flex flex-col items-center justify-center px-5 group  mb-4">
                    ...
                    <span className="text-[9px] text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500 uppercase ">
                        <NavLink style={({ isActive }) => ({
                            color: isActive ? '#537aa4' : '#ccc',
                        })} to="/">Inici
                        </NavLink></span>
                ...
                <button type="button" className="inline-flex flex-col items-center justify-center px-5 group mb-4">
                    <div className="w-5 h-5 mb-2 text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500" aria-hidden="true" >
                        <NavLink style={({ isActive }) => ({
                            color: isActive ? '#537aa4' : '#ccc',
                        })} to="https://www.instagram.com/efsmasquefa/">   <FontAwesomeIcon icon={faPhotoVideo} /></NavLink></div>
                    <span className="text-[9px] text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500 uppercase ">
                        <NavLink style={({ isActive }) => ({
                            color: isActive ? '#537aa4' : '#ccc',
                        })} to="https://www.instagram.com/efsmasquefa/">  Instagram</NavLink>
                    </span>
                </button>
            </div>
        </div>
